...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/papamundi)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/papamundi
```

A live public deployment of this template is available at [https://papamundi.templates.workers.dev](https://papamundi.templates.workers.dev)
